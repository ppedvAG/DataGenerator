...
{
    internal static class FillerGenerator
    {
        public static 
            (Filler<Customer> customerFiller,
             Filler<Order> orderFiller,
             Filler<OrderDetail> orderDetailsFiller,
             Filler<Product> productFiller) GetAllFillers() => 
             (
                 GetCustomerFiller(), 
                 GetOrderFiller(),
                 GetOrderDetailFiller(),
                 GetProductFiller()
             );
        ...
        public static Filler<OrderDetail> GetOrderDetailFiller()
        {
